...
\textbf{Implementação}: na fase 2, o \emph{boss} mantém disparos em cone de três
plasmas a cada 0,45\,s, avança em \emph{melee} \emph{e} invoca grupos de três
\texttt{Seekers} a cada 1,8\,s.\\
\textbf{Razão}: o mesmo modo de dificuldade alta exigiu intensificar a fase 2.
Sem projéteis, a fase 2 ficaria mais fácil que a 1, contra-intuitivo.

\subsubsection*{Densidade de inimigos por sala}

\textbf{GDD}: não especifica número exato; prescreve aumento progressivo entre
andares.\\
\textbf{Implementação}: 16 a 21 inimigos por sala no Andar 1, 23 a 28 no Andar 2
e 30 a 35 no Andar 3 (modo de dificuldade alta).\\
