...
\begin{description}
  ...
  \item[\texttt{entity\_bomber\_t}] (HP 2). Persegue agressivamente; ao chegar a 18
    unidades de distância, ativa um \emph{fuse} de 1,1\,s e explode, causando dano em
    raio de 24 unidades. Introduzido no Andar 3.
  \item[\texttt{entity\_boss\_t}] (HP 50). Adversário do Andar 3, com duas fases:
    \begin{enumerate}
      \item Fase 1 (HP > 25): atira anéis de 5 plasmas em padrão rotativo a cada 0,35\,s.
      \item Fase 2 (HP $\leq$ 25): avança em \emph{melee}, invoca pares de
        \texttt{entity\_seeker\_t} a cada 3,0\,s e dispara plasmas individuais a cada
        0,7\,s.
    \end{enumerate}
\end{description}
